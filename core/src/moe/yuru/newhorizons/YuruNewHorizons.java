...
public class YuruNewHorizons extends ApplicationAdapter {
	...
	public void create() {
		...
		// La Camera fait la traduction entre notre code en 1280x720 et la taille réelle de la fenêtre
	...
	// Etapes effectuées pour chaque rendu d'une frame
	@Override
	public void render() {
		camera.update();	// maj des données de la camera
		batch.setProjectionMatrix(camera.combined);		// dit en gros au moteur d'utiliser la camera pour la trad code <-> taille réelle
		// Les instr de rendu entre begin et end seront faites en 1 coup (> rendu efficace, vive les fps)
		batch.begin();
		...
		// Ressemble pas mal à ce qu'on fait avec Swing en TP/TD
